...
The course is a sequel of last semester's course on [Programming Languages](https://github.com/alexhkurz/programming-languages). Nevertheless, with some extra effort, it can also be followed independently as everything will be explained. Last semester, among other things, we
- explained the basic ideas of parsing,
- saw some simple context free grammars in BNFC,
- wrote some functional programs (in Haskell and LambdaNat)
...
If I had to summarise the course in one slogan, I would say
    ...
    compilers translates languages by recursion on the abstract syntax tree.
